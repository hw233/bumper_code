...
#pragma pack(1)
/**/
struct ProtocolHead14Byte
{
	UInt32  webSocketHead1;
	SHORT   webSocketHead2;
	UInt32  packageID;            // pkg length
	UInt32  packageLen;          // adler32 check, adler32 of command, retCode and protobufData ProtocolHead
	char    protobufData[0];
};
struct ProtocolHead16Byte
{
	UInt32  webSocketHead1;
	UInt32  webSocketHead2;
	UInt32  packageID;            // pkg length
	UInt32  packageLen;          // adler32 check, adler32 of command, retCode and protobufData ProtocolHead
	char    protobufData[0];
};
