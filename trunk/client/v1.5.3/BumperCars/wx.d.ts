...
declare namespace wx {
	...
	export function createGameClubButton(object: Object): void;
	...
	export interface RewardedVideoAd{
		...
		//监听激励视频广告加载事件
		onLoad(callback: Function): RewardedVideoAd;

		//取消监听激励视频广告加载事件
		offLoad(callback: Function): RewardedVideoAd;

		//监听激励视频错误事件
		onError(callback: Function): RewardedVideoAd;

		//取消监听激励视频错误事件
		offError(callback: Function): RewardedVideoAd;

		//监听用户点击 关闭广告 按钮的事件
		onClose(callback: Function): RewardedVideoAd;

		//取消监听用户点击 关闭广告 按钮的事件
		offClose(callback: Function): RewardedVideoAd;
	}
	...
	export function vibrateShort(object: Object): void;
